    ...
    return Stack(
      children: [
        ...
        Positioned(top: 140, left: -60,
            child: _heart(250, Colors.blueAccent.withOpacity(0.12))),
        Positioned(top: 60, right: 0,
            child: _heart(160, Colors.lightBlue.withOpacity(0.10))),
        Positioned(bottom: -80, right: -50,
            child: _heart(280, Colors.indigoAccent.withOpacity(0.15))),
      ],
    );
  }
